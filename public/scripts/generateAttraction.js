	...
	generateAttraction = function (config) {
		...
		return {
			...
			buildItineraryItem: function () {
				...
				// var buildItinItemAjax = function (attractionType) {
    //                 $.post('/days/'+currentDay._id+'/'+attractionType, { aId: AttractionId
    //                         //currentDay id needs to be sent.
    //                 });
    //             } 

    //             if (self instanceof Hotel) {
    //                 buildItinItemAjax('hotel')
    //             } else if (self instanceof Restaurant) {
    //                 buildItinItemAjax('restaurants')
    //             } else {
    //                 buildItinItemAjax('thingsToDo')
    //             } 
